...
const ROLE_TRANSITIONS: Record<string, string[]> = {
  ...
  'RECU_REJETE': ['ADMINISTRATEUR', 'TECHNIQUE', 'SANTE'],
  'EN_ANALYSE_VALIDE': ['ADMINISTRATEUR', 'TECHNIQUE'],
  'EN_ANALYSE_REJETE': ['ADMINISTRATEUR', 'TECHNIQUE', 'SANTE'],
  'VALIDE_EN_COMPTABILITE': ['ADMINISTRATEUR', 'TECHNIQUE'],
  'VALIDE_REJETE': ['ADMINISTRATEUR', 'TECHNIQUE', 'SANTE'],
  'EN_COMPTABILITE_EN_PAIEMENT': ['ADMINISTRATEUR', 'COMPTABILITE'],
  'EN_COMPTABILITE_REJETE': ['ADMINISTRATEUR', 'COMPTABILITE', 'SANTE'],
  'EN_PAIEMENT_PAYE': ['ADMINISTRATEUR', 'COMPTABILITE'],
  'EN_PAIEMENT_REJETE': ['ADMINISTRATEUR', 'COMPTABILITE', 'SANTE'],
};
